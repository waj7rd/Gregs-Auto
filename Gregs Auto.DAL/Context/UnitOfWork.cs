...
{
    private readonly GregsAutoContext _context;

    public UnitOfWork(GregsAutoContext context)
    {
        _context = context;
    }
    ...
    public async Task<T> ExecuteAsync<T>(Func<Task<T>> operation)
    {
        ...
        // classes call each other (accepting a request calls the booking
        ...
        // exists to prevent — the customer created just before the booking was
        // turned down.
