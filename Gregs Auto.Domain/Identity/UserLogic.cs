...
public class UserLogic : IUserLogic
{
    ...
    // guessing pointless, without locking a technician out of their own shop
    ...
    public UserLogic(IUserRepository userRepository, ILoginAuditRepository auditRepository, IShopClock clock)
    {
    ...
    public async Task<StaffResult> CreateStaffAsync(string fullName, string email, string role, string password)
    {
        ...
        var existing = await _userRepository.GetAsync(u => u.Email == email);
        if (existing != null)
